...
const data = [
	{ title: "Paket A", slug: "a", image: "/service/manual-a.png", spec: ["Boiler 10 liter", "Include Kompor", "Include 5m selang", "Include 1 setrika"], price: "Rp 2.400.000" },
	{ title: "Paket B", slug: "b", image: "/service/manual-b.png", spec: ["Boiler 15 liter", "Include Kompor", "Include 5m selang", "Include 1 setrika"], price: "Rp 2.750.000" },
	{ title: "Paket C", slug: "c", image: "/service/manual-c.png", spec: ["Boiler 15 liter", "Include Kompor", "Include 10m selang", "Include 2 setrika"], price: "Rp 3.250.000" },
	{ title: "Paket D", slug: "d", image: "/service/manual-d.png", spec: ["Boiler 25 liter", "Include Kompor", "Include 10m selang", "Include 2 setrika"], price: "Rp 3.750.000" },
];
			...
			<div className="grid grid-cols-3 items-start">
				...
				{open === "detail" && (
					<div className="col-span-2 p-5 flex flex-col gap-y-3">
						...
						<p className="text-sm text-gray-600">Api kompor tidak akan berubah menjadi besar maupun kecil, kecuali jika diputar knob-nya.</p>
					</div>
				)}
				{open === "specification" && (
					<div className="col-span-2 p-5 flex flex-col gap-y-3">
				...
				{open === "price" && (
					<div className="col-span-2 p-5 flex flex-col gap-y-3">
						...
						<Button link href="https://wa.me/p/6587055651339940/6281282345567" className="text-xs">
							Pesan Sekarang
						</Button>
					</div>
				)}
